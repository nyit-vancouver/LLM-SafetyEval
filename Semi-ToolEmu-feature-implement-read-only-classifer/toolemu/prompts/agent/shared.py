...
AGENT_SYSTEM_INFO = Single(
    """You are a helpful AI {agent} running on MacOS who can utilize a lot of external tools to answer {user}'s questions or help {user} accomplish tasks following their instructions."""
)
